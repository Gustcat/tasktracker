...
//go:generate minimock -i github.com/Gustcat/auth/internal/repository.UserRepository -o user_repository_minimock.go -n UserRepositoryMock -p mocks
...
type UserRepositoryMock struct {
	...
	funcGet          func(ctx context.Context, id int64) (i1 int64, up1 *model.UserInfo, t1 time.Time, n1 sql.NullTime, err error)
...
func (mmCreate *mUserRepositoryMockCreate) Expect(ctx context.Context, info *model.UserInfo, pwd string) *mUserRepositoryMockCreate {
	...
	mmCreate.defaultExpectation.params = &UserRepositoryMockCreateParams{ctx, info, pwd}
...
// ExpectPwdParam3 sets up expected param pwd for UserRepository.Create
func (mmCreate *mUserRepositoryMockCreate) ExpectPwdParam3(pwd string) *mUserRepositoryMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserRepositoryMock.Create mock is already set by Set")
	}
...
func (mmCreate *mUserRepositoryMockCreate) Inspect(f func(ctx context.Context, info *model.UserInfo, pwd string)) *mUserRepositoryMockCreate {
...
func (mmCreate *mUserRepositoryMockCreate) Set(f func(ctx context.Context, info *model.UserInfo, pwd string) (i1 int64, err error)) *UserRepositoryMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mUserRepositoryMockCreate) When(ctx context.Context, info *model.UserInfo, pwd string) *UserRepositoryMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserRepositoryMock.Create mock is already set by Set")
	}
	...
	expectation := &UserRepositoryMockCreateExpectation{
		mock:               mmCreate.mock,
		params:             &UserRepositoryMockCreateParams{ctx, info, pwd},
...
func (mmCreate *UserRepositoryMock) Create(ctx context.Context, info *model.UserInfo, pwd string) (i1 int64, err error) {
	...
	mm_params := UserRepositoryMockCreateParams{ctx, info, pwd}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockCreateParams{ctx, info, pwd}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.pwd != nil && !minimock.Equal(*mm_want_ptrs.pwd, mm_got.pwd) {
				mmCreate.t.Errorf("UserRepositoryMock.Create got unexpected parameter pwd, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmCreate.t.Fatalf("Unexpected call to UserRepositoryMock.Create. %v %v %v", ctx, info, pwd)
	return
}
...
func (mmGet *mUserRepositoryMockGet) Return(i1 int64, up1 *model.UserInfo, t1 time.Time, n1 sql.NullTime, err error) *UserRepositoryMock {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserRepositoryMock.Get mock is already set by Set")
	}
	...
	mmGet.defaultExpectation.results = &UserRepositoryMockGetResults{i1, up1, t1, n1, err}
	mmGet.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
	return mmGet.mock
}

// Set uses given function f to mock the UserRepository.Get method
func (mmGet *mUserRepositoryMockGet) Set(f func(ctx context.Context, id int64) (i1 int64, up1 *model.UserInfo, t1 time.Time, n1 sql.NullTime, err error)) *UserRepositoryMock {
	if mmGet.defaultExpectation != nil {
...
func (e *UserRepositoryMockGetExpectation) Then(i1 int64, up1 *model.UserInfo, t1 time.Time, n1 sql.NullTime, err error) *UserRepositoryMock {
	e.results = &UserRepositoryMockGetResults{i1, up1, t1, n1, err}
	return e.mock
}
...
func (mmGet *UserRepositoryMock) Get(ctx context.Context, id int64) (i1 int64, up1 *model.UserInfo, t1 time.Time, n1 sql.NullTime, err error) {
	...
	for _, e := range mmGet.GetMock.expectations {
		if minimock.Equal(*e.params, mm_params) {
			mm_atomic.AddUint64(&e.Counter, 1)
			return e.results.i1, e.results.up1, e.results.t1, e.results.n1, e.results.err
		}
	}
	...
	if mmGet.GetMock.defaultExpectation != nil {
		...
		return (*mm_results).i1, (*mm_results).up1, (*mm_results).t1, (*mm_results).n1, (*mm_results).err
	}
...
// ExpectNameParam3 sets up expected param name for UserRepository.Update
func (mmUpdate *mUserRepositoryMockUpdate) ExpectNameParam3(name string) *mUserRepositoryMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
...
// ExpectEmailParam4 sets up expected param email for UserRepository.Update
func (mmUpdate *mUserRepositoryMockUpdate) ExpectEmailParam4(email string) *mUserRepositoryMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.name != nil && !minimock.Equal(*mm_want_ptrs.name, mm_got.name) {
				mmUpdate.t.Errorf("UserRepositoryMock.Update got unexpected parameter name, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
			...
			if mm_want_ptrs.email != nil && !minimock.Equal(*mm_want_ptrs.email, mm_got.email) {
				mmUpdate.t.Errorf("UserRepositoryMock.Update got unexpected parameter email, expected at\n%s:\nwant: %#v\n got: %#v%s\n",

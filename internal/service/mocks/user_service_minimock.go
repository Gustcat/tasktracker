...
//go:generate minimock -i github.com/Gustcat/auth/internal/service.UserService -o user_service_minimock.go -n UserServiceMock -p mocks
...
type UserServiceMock struct {
	...
	funcCreate          func(ctx context.Context, info *model.UserInfo, pwd string) (i1 int64, err error)
	funcCreateOrigin    string
	inspectFuncCreate   func(ctx context.Context, info *model.UserInfo, pwd string)
	...
	funcGet          func(ctx context.Context, id int64) (i1 int64, up1 *model.UserInfo, tp1 *timestamppb.Timestamp, tp2 *timestamppb.Timestamp, err error)
...
func (mmCreate *mUserServiceMockCreate) Expect(ctx context.Context, info *model.UserInfo, pwd string) *mUserServiceMockCreate {
	...
	mmCreate.defaultExpectation.params = &UserServiceMockCreateParams{ctx, info, pwd}
...
// ExpectPwdParam3 sets up expected param pwd for UserService.Create
func (mmCreate *mUserServiceMockCreate) ExpectPwdParam3(pwd string) *mUserServiceMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserServiceMock.Create mock is already set by Set")
	}
	...
	mmCreate.defaultExpectation.paramPtrs.pwd = &pwd
	mmCreate.defaultExpectation.expectationOrigins.originPwd = minimock.CallerInfo(1)

	return mmCreate
}

// Inspect accepts an inspector function that has same arguments as the UserService.Create
func (mmCreate *mUserServiceMockCreate) Inspect(f func(ctx context.Context, info *model.UserInfo, pwd string)) *mUserServiceMockCreate {
...
func (mmCreate *mUserServiceMockCreate) Set(f func(ctx context.Context, info *model.UserInfo, pwd string) (i1 int64, err error)) *UserServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mUserServiceMockCreate) When(ctx context.Context, info *model.UserInfo, pwd string) *UserServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserServiceMock.Create mock is already set by Set")
	}
	...
	expectation := &UserServiceMockCreateExpectation{
		mock:               mmCreate.mock,
		params:             &UserServiceMockCreateParams{ctx, info, pwd},
...
func (mmCreate *UserServiceMock) Create(ctx context.Context, info *model.UserInfo, pwd string) (i1 int64, err error) {
	...
	if mmCreate.inspectFuncCreate != nil {
		mmCreate.inspectFuncCreate(ctx, info, pwd)
	}

	mm_params := UserServiceMockCreateParams{ctx, info, pwd}
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		mm_got := UserServiceMockCreateParams{ctx, info, pwd}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.pwd != nil && !minimock.Equal(*mm_want_ptrs.pwd, mm_got.pwd) {
				mmCreate.t.Errorf("UserServiceMock.Create got unexpected parameter pwd, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmCreate.CreateMock.defaultExpectation.expectationOrigins.originPwd, *mm_want_ptrs.pwd, mm_got.pwd, minimock.Diff(*mm_want_ptrs.pwd, mm_got.pwd))
			}
	...
	if mmCreate.funcCreate != nil {
		return mmCreate.funcCreate(ctx, info, pwd)
	}
	mmCreate.t.Fatalf("Unexpected call to UserServiceMock.Create. %v %v %v", ctx, info, pwd)
	return
}
...
type UserServiceMockGetResults struct {
	i1  int64
	up1 *model.UserInfo
	tp1 *timestamppb.Timestamp
	tp2 *timestamppb.Timestamp
	err error
}
...
func (mmGet *mUserServiceMockGet) Return(i1 int64, up1 *model.UserInfo, tp1 *timestamppb.Timestamp, tp2 *timestamppb.Timestamp, err error) *UserServiceMock {
	if mmGet.mock.funcGet != nil {
		mmGet.mock.t.Fatalf("UserServiceMock.Get mock is already set by Set")
	}
	...
	mmGet.defaultExpectation.results = &UserServiceMockGetResults{i1, up1, tp1, tp2, err}
	mmGet.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
	return mmGet.mock
}

// Set uses given function f to mock the UserService.Get method
func (mmGet *mUserServiceMockGet) Set(f func(ctx context.Context, id int64) (i1 int64, up1 *model.UserInfo, tp1 *timestamppb.Timestamp, tp2 *timestamppb.Timestamp, err error)) *UserServiceMock {
	if mmGet.defaultExpectation != nil {
...
func (e *UserServiceMockGetExpectation) Then(i1 int64, up1 *model.UserInfo, tp1 *timestamppb.Timestamp, tp2 *timestamppb.Timestamp, err error) *UserServiceMock {
	e.results = &UserServiceMockGetResults{i1, up1, tp1, tp2, err}
	return e.mock
}
...
func (mmGet *UserServiceMock) Get(ctx context.Context, id int64) (i1 int64, up1 *model.UserInfo, tp1 *timestamppb.Timestamp, tp2 *timestamppb.Timestamp, err error) {
	...
	for _, e := range mmGet.GetMock.expectations {
		if minimock.Equal(*e.params, mm_params) {
			mm_atomic.AddUint64(&e.Counter, 1)
			return e.results.i1, e.results.up1, e.results.tp1, e.results.tp2, e.results.err
		}
	}
	...
	if mmGet.GetMock.defaultExpectation != nil {
		...
		return (*mm_results).i1, (*mm_results).up1, (*mm_results).tp1, (*mm_results).tp2, (*mm_results).err
	}
...
// ExpectNameParam3 sets up expected param name for UserService.Update
func (mmUpdate *mUserServiceMockUpdate) ExpectNameParam3(name string) *mUserServiceMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
...
// ExpectEmailParam4 sets up expected param email for UserService.Update
func (mmUpdate *mUserServiceMockUpdate) ExpectEmailParam4(email string) *mUserServiceMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserServiceMock.Update mock is already set by Set")
	}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.name != nil && !minimock.Equal(*mm_want_ptrs.name, mm_got.name) {
				mmUpdate.t.Errorf("UserServiceMock.Update got unexpected parameter name, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
			...
			if mm_want_ptrs.email != nil && !minimock.Equal(*mm_want_ptrs.email, mm_got.email) {
				mmUpdate.t.Errorf("UserServiceMock.Update got unexpected parameter email, expected at\n%s:\nwant: %#v\n got: %#v%s\n",

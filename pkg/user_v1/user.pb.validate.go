...
func (m *CreateRequest) validate(all bool) error {
	...
	if l := utf8.RuneCountInString(m.GetPassword()); l < 8 || l > 10 {
		err := CreateRequestValidationError{
			field:  "Password",
			reason: "value length must be between 8 and 10 runes, inclusive",
		}
		if !all {
			return err
		}
	...
	if !_CreateRequest_Password_Pattern.MatchString(m.GetPassword()) {
		err := CreateRequestValidationError{
			field:  "Password",
			reason: "value does not match regex pattern \"^[A-Za-z0-9@$!%*?&]*[0-9@$!%*?&][A-Za-z0-9@$!%*?&]*$\"",
		}
		if !all {
			return err
		}
	...
	if l := utf8.RuneCountInString(m.GetPasswordConfirm()); l < 8 || l > 10 {
		err := CreateRequestValidationError{
...
var _CreateRequest_Password_Pattern = regexp.MustCompile("^[A-Za-z0-9@$!%*?&]*[0-9@$!%*?&][A-Za-z0-9@$!%*?&]*$")

var _CreateRequest_PasswordConfirm_Pattern = regexp.MustCompile("^[A-Za-z0-9@$!%*?&]*[0-9@$!%*?&][A-Za-z0-9@$!%*?&]*$")
...
func (m *UpdateRequest) validate(all bool) error {
	...
	if l := utf8.RuneCountInString(m.GetName()); l < 0 || l > 50 {
